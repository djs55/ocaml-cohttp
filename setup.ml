...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2799218601b78add081f2e54a7be26c0) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("cohttp", OCamlbuildDocPlugin.doc_build "lib");
     ...
     clean_doc =
       [
          ("cohttp", OCamlbuildDocPlugin.doc_clean "lib");
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "([o\181\218\153\029<l\191\014\150,gT\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
